...
public class InteropConsumeTest {
  ...
  public void testDecodeFromBarcode() throws Exception {
    ...
    // Verify signature
    final DefaultHCertSignatureVerifier verifier = new DefaultHCertSignatureVerifier();
    HCertSignatureVerifier.Result result = verifier.verify(cwt, (c,k) -> Arrays.asList(cert));
    ...
    final CBORObject hcertObject = CBORObject.DecodeFromBytes(result.getHcert()); 
    System.out.println(hcertObject.ToJSONString());
